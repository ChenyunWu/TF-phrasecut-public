...
def rmi_refvg_predictor(split='val', eval_img_count=-1, out_path='output/eval_refvg/rmi', model_iter=750000,
                        dcrf=True, mu=the_mu):
    pretrained_model = './_rmi/refvg/tfmodel/refvg_resnet_RMI_iter_' + str(model_iter) + '.tfmodel'
    ...
    model = RMI_model(H=H, W=W, mode='eval', vocab_size=vocab_size, weights='resnet')
